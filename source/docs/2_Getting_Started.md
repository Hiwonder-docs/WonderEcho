...
The default firmware includes preloaded command words and broadcast statements. Broadcast statements are passive and must be triggered by sending data to the module. For more details, please refer to [Command Word Broadcasting Protocol List](https://wiki.hiwonder.com/projects/WonderEcho/en/latest/docs/Appendix.html).
